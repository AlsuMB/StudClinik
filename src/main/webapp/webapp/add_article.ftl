...
<#macro content>
    <form  enctype='multipart/form-data' action="/add_new_article" method="post">
        <div class="form-group">
            <label for="exampleFormControlInput1" style="font-size: 30px">Тема статьи: </label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="title"></textarea>
        </div>
        <div class="form-group">
            <label for="exampleFormControlTextarea1" style="font-size: 30px">Ваша статья: </label>
        ...
        <input type="submit" class="btn btn-primary"
               style="margin-top: 30px; margin-left: 1100px; margin-bottom: 20px; padding: 10px 20px 10px 20px; color: #116062; background-color: #ffffff">
    </form>
