<#ftl encoding="utf-8">
<#include "base.ftl">
<#macro title>Изменить аккаунт</#macro>
<#macro css>
    <link rel="stylesheet" href="../webapp/css/update_account_page.css">
</#macro>
<#macro content>
    <form action="/update_account" method="post" enctype='multipart/form-data'>
        ...
        <input type="submit" class="btn btn-primary" style="margin-left: 50px; margin-top: 50px; margin-bottom: 50px">
    </form>
